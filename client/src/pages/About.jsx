...
export default function About() {
  return (
    <div className="px-6 sm:px-4 py-6 max-w-4xl mx-auto mt-6 min-h-screen">
      ...
      <div className=" text-gray-600 font-extralight ">
        ...
        <p className="mb-4  text-xs sm:text-sm leading-relaxed">
          ...
          life, and started coding. I always had a keen interest in development
          and so I enrolled in a software engineering course setup by Hyperion
          Development. I decided to branch more into the frontend side and
          learnt frameworks and libraries such as React and Tailwind CSS,
          bringing life into my APIs and NodeJS applications.
        </p>
        <p className="mb-4  text-xs sm:text-sm leading-relaxed">
